...
ApklisReleaseModel _$ApklisReleaseModelFromJson(Map<String, dynamic> json) {
  return ApklisReleaseModel()
    ..abi = (json['abi'] as List)
        ?.map((e) => e == null
            ? null
            : ApklisAbiModel.fromJson(e as Map<String, dynamic>))
        ?.toList()
    ...
    ..permissions = (json['permissions'] as List)
        ?.map((e) => e == null
            ? null
            : ApklisPermissionModel.fromJson(e as Map<String, dynamic>))
        ?.toList()
    ..screenshots = (json['screenshots'] as List)
        ?.map((e) => e == null
            ? null
            : ApklisScreenshotModel.fromJson(e as Map<String, dynamic>))
        ?.toList()
